...
"[project]/lib/types/database.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/(main)/projects/submit/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/types/database.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function SubmitProjectPage() {
    ...
    // ── Academic ──
    const [program, setProgram] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('B.Tech');
    ...
    // ── Team ──
    const [isTeam, setIsTeam] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [facultyGuide, setGuide] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    // ── Links ──
    ...
    const semesters = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEMESTERS_BY_PROGRAM"][program] ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SEMESTERS_BY_PROGRAM"]['B.Tech'];
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubmitProjectPage.useEffect": ()=>{
            const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
            supabase.auth.getUser().then({
                "SubmitProjectPage.useEffect": ({ data: { user } })=>{
                    if (!user) {
                        window.location.href = '/login';
                        return;
                    }
                    setUserId(user.id);
                    supabase.from('tags').select('*').order('name').then({
                        "SubmitProjectPage.useEffect": ({ data })=>setTags(data ?? [])
                    }["SubmitProjectPage.useEffect"]);
                    supabase.from('team_members').select('team_id, role, teams(id, name, faculty_guide)').eq('profile_id', user.id).in('role', [
                        'leader',
                        'member'
                    ]).then({
                        "SubmitProjectPage.useEffect": ({ data })=>{
                            setMyTeams(data?.map({
                                "SubmitProjectPage.useEffect": (m)=>m.teams
                            }["SubmitProjectPage.useEffect"]).filter(Boolean) ?? []);
                        }
                    }["SubmitProjectPage.useEffect"]);
                    // Pre-fill program from profile
                    supabase.from('profiles').select('program, branch').eq('id', user.id).single().then({
                        "SubmitProjectPage.useEffect": ({ data })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubmitProjectPage.useEffect": ()=>{
            ...
            const t = myTeams.find({
                "SubmitProjectPage.useEffect.t": (t)=>t.id === teamId
            }["SubmitProjectPage.useEffect.t"]);
    ...
    async function handleSubmit(e) {
        e.preventDefault();
        if (!title.trim()) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Project title is required', 'error');
            return;
        }
        if (!description.trim()) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Short description is required', 'error');
            return;
        }
        if (!docFile && !longDesc.trim()) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Upload documentation or write a project description', 'error');
            return;
        }
        if (!userId) return;
        setLoading(true);
        ...
        if (docFile) {
            ...
            if (!error) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Documentation upload failed — check storage bucket exists', 'error');
                setLoading(false);
                return;
            }
        }
        ...
        if (projErr || !project) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Failed to submit — ' + projErr?.message, 'error');
            setLoading(false);
            return;
        }
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"])('Project submitted!', 'success');
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            docFile && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                style: {
                                    marginTop: 14
                                },
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            isTeam && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                style: {
                                    display: 'grid',
                                    gap: 14
                                },
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Field, {
                                        ...
                                        children: myTeams.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                myTeams.map((t)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: t.id,
                                                        children: t.name
                                                    }, t.id, false, {
                                                        fileName: "[project]/app/(main)/projects/submit/page.tsx",
                            ...
                            !isTeam && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Field, {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Field, {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            children: [
                                                ...
                                                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$types$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ACADEMIC_YEARS"].map((y)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: y,
                                                        children: y
                                                    }, y, false, {
                                                        fileName: "[project]/app/(main)/projects/submit/page.tsx",
...
_s(SubmitProjectPage, "8buGfYe+Ku2PkM68CbZAhUz5m4A=");
_c1 = SubmitProjectPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "Field");
__turbopack_context__.k.register(_c1, "SubmitProjectPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_d70c581f._.js.map